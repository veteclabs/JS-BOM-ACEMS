            ...
            <div class="row">
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content ibox-noborder-content">
                            <dx-chart
                                    ...
                                    :data-source="departmentChartData"
                                    :series="chartSeries"
                ...
                <div class="col-lg-6">
                    <div class="ibox">
                        <div class="ibox-2Depth location-rate-box">
                            ...
                            <div class="ibox-content ibox-noborder-content">
                                ...
                                <ul class="location-piechart-ul">
                                    <li v-for="(item, index) in departmentChartData" :key="index">
                                        <p v-show="params.department !== 'AU'">
                        ...
                        <div class="flex-box location-minmax-box" v-show="params.department === 'AU'">
                            <div>
                                <div class=" location-min-box ibox-2Depth">
                                    <p>최소 사용 부서는</p>
                                    <p><span class="green">{{minDepartment}}</span>입니다.</p>
                                </div>
                            </div>
                            <div>
                                <div class=" location-max-box ibox-2Depth">
                                    <p>최대 사용 부서는</p>
                                    <p><span class="red">{{maxDepartment}}</span>입니다.</p>
                                </div>
                            </div>
                        </div>
                        <div class="flex-box location-minmax-box" v-show="params.department !== 'AU'">
                            ...
                            >
                                ...
                                <div class="flex-box">
                                    <div v-if="params.timeType !== 'Y'"
                                         :class="[ item.value - item.beforeValue < 0 ? 'normal' : 'warning']">
                                        <p>
    ...
    export default {
        ...
        data() {
            return {
                ...
                filterSettingData: {
                    ...
                    department: {show: true, type: 'select'},
                },
                msgData: {
                    // 알람모달
                    msg: '',
        ...
        methods: {
            ...
            async getSearch(params) {
                ...
                axios({
                    method: 'GET',
                    url: '/api/analysis/department',
                    params: params,
                }).then((res) => {
                    if (res.data.code === 1) {
                        vm.chartData = [];
                        vm.gridDataColumn = [];
                        vm.departmentChartData = [];
                        vm.chartSeries = [];
                        vm.maxDepartment = '-';
                        vm.minDepartment = '-';
                        vm.maxLocation = '-';
            ...
            resultLocationArray(result) {
                ...
                if (vm.params.department === 'AU') {
                    vm.departmentChartData = result;
                    vm.argumentField = 'departmentName'
                } else {
                    ...
                    vm.departmentChartData = topArray.slice(0, 10);
                }
            ...
            keywordCalc(result) {
                ...
                if (locationMax.length !== 0) {
                    vm.maxDepartment = `${locationMax[0][vm.argumentField]}`;
                } else {
                    vm.maxDepartment = '-';
                }

                if (locationMin.length !== 0) {
                    vm.minDepartment = `${locationMin[0][vm.argumentField]}`;
                } else {
                    vm.minDepartment = '-';
                }
            ...
            customizePoint(arg) {
                if (this.departmentChartData.length > 3) {
                    const {min} = this;
                    const {max} = this;
                    const {value} = arg;
