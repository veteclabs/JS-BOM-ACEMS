...
// 장치 관리
app.get('/compressors', settingEquipment);
app.get('/dayofweek', settingEquipment);
app.get('/week', settingEquipment);
...
app.post('/compressor', settingEquipment);
app.put('/compressor/:deviceId', settingEquipment);
...
rule.id = 1;
schedule.scheduleJob("1", rule, () => {
  console.log("ewf");
});
schedule.scheduleJob("2", rule, () => {
  console.log("ewf");
});
